    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            ...
            >
                ...
                <button
                    type="submit"
                    className="w-full bg-blue-600 text-white font-semibold py-2 rounded hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-300 transition-all duration-200"
                >
                    Register
                </button>
